<template>
  <div class="right_main_under">
    ...
    >
      ...
      <el-table-column label="诈骗时间" prop="fraudTime" show-overflow-tooltip>
      </el-table-column>
      <el-table-column
        width="200"
      ...
      <el-table-column label="预警等级" prop="earlyGrade" width="100">
      </el-table-column>
      ...
      <!-- <el-table-column label="数据源" prop="dataSource" width="100">
      </el-table-column> -->
      <!-- <el-table-column
        label="手机号归属地"
        prop="phoneAddress"
      ...
      <el-table-column label="诈骗网站IP" prop="fraudIp" show-overflow-tooltip>
      </el-table-column>
      <el-table-column label="诈骗网站端口" prop="fraudPort" width="100">
      </el-table-column>
      <el-table-column
        label="诈骗网站IP归属地"
        prop="fraudIpAscription"
        width="100"
      >
      </el-table-column> -->
